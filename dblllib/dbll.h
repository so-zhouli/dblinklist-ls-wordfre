...
void tail_insert_elem_dbll(DList*list,Elemtype value);
void delete_elem_dbll(DList*list,pNODE p_node);
pNODE search_elem_dbll(DList*list,Elemtype key,dbll_compare_cb compare);
void quick_sort_dbll(pNODE p_left,pNODE p_right,int left,int right,dbll_compare_cb compare);//left初始为1
